            ...
            <div className="table-responsive">
                <table className="table align-items-center table-flush table-hover">
                    <thead className="thead-light">
                        <tr>
                            <th scope="col" className="sort" data-sort="name">Lộ trình </th>
                            <th scope="col" className="sort" data-sort="numberphone">Ngày bắt đầu chạy</th>
                            <th scope="col" className="sort" data-sort="numberphone">Giá Vé</th>
                            <th scope="col" className="sort" data-sort="numberphone">Tài xế</th>
                            ...
                            props?.trip?.map((tripItem: Trip) => {
                                return (
                                    <tr>
                                        ...
                                        <td>
                                            <span className="text-muted">{tripItem?.drive?.name || ""}</span>
                                        </td>
